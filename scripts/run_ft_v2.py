"""Run fine-tuned v2 model on signal + bottom + held-out lots для сравнения с v1."""
...
log = logging.getLogger("ftv2")

RAW = ROOT / "data/raw/bulk"
OUT = ROOT / "data/reports/bulk_ft_v2"
OUT.mkdir(parents=True, exist_ok=True)

# Read v2 fine-tuned model
...
log.info("FT v2 model: %s", FT_MODEL)

LOTS = [
    # Signal lots (10)
    "169592487", "169618056", "169625341", "169625660", "169629574",
    "169638071", "169638083", "169642564", "169596304", "169625733",
